...
std::string humanize_integer(unsigned long long int);

std::string humanize_double(long double, int = 2);

std::string monetize_double(long double, int = 2);

double calculate_retail(double whole_sale_cost, double);
...
std::string monetize_double(const long double double_value, const int precision) {
